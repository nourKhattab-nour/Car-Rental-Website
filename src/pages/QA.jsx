...
const QA = () => {
  ...
  const questions = [
    {
      ...
      answer: 'You can get a refund by contacting our customer service team at 1-800-123-4567',
    },
    {
      id: 2,
  ...
  return (
    <>
      <Navbar />
      <div className="w-screen min-h-screen bg-white flex flex-col items-center py-10">
        <div className="w-[89%] m-auto max-w-[1400px] bg-white p-5 rounded-lg shadow-lg">
          ...
          {questions.map((q, index) => (
            <div key={q.id} className="mb-4 last:mb-0">
              ...
              >
                {q.question}
                {activeQuestion === index ? <FaMinusCircle /> : <FaPlusCircle />}
              </button>
              <AnimatePresence>
                {activeQuestion === index && (
                  <motion.div 
                    ...
                    className="p-4 bg-gray-50 rounded-lg shadow-md mt-2"
                  >
                    {q.answer}
                  </motion.div>
                )}
